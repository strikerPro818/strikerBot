...
###Build OpenCV from source with CUDA and cuDNN for Jetson Xavier NX###
...
readonly DEFAULT_VERSION=4.7.0  # controls the default version (gets reset by the first argument)
