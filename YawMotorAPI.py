...
class Servo(object):
    ...
    def connect(self):
        ...
        self.bus = can.interface.Bus(bustype='slcan',
                                     # uses serial CAN, but there a usb2can interfact defined in https://python-can.readthedocs.io/en/stable/configuration.html
    ...
    def go_to_angle(self, servo_id, desired_angle, max_speed, timeout=10):
        ...
        if msg:
            ...
            return (motor_temp, torque_current_low_byte, torque_current_high_byte, speed_low_byte, speed_high_byte,
                    angle_low_byte, angle_high_byte)
        else:
